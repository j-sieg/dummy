module Users
  class PasswordsController < ApplicationController
    def update
      ...
      if password.save
        redirect_to users_settings_url, notice: "Successfully changed your password."
      else
        respond_to do |format|
          format.html { redirect_to users_settings_url, alert: "Failed to change your password." }
